export const skills = [
    // Frontend
    { name: "Angular", stars: 4, category: "Frontend" },
    { name: "JavaScript", stars: 5, category: "Frontend" },
    { name: "TypeScript", stars: 5, category: "Frontend" },
    { name: "Vue3", stars: 5, category: "Frontend" },
    ...
    { name: "Hibernate", stars: 3, category: "Backend" },
    ...
    { name: "Docker", stars: 3, category: "Tools" },
    { name: "Jenkins", stars: 3, category: "Tools" },
    ...
    { name: "Cypress", stars: 4, category: "Tools" },
    { name: "Unit Testing", stars: 5, category: "Tools" },
    { name: "Checkmarx", stars: 5, category: "Tools" },
    { name: "Phrase", stars: 5, category: "Tools" },
    { name: "GitHub", stars: 4, category: "Tools" },
    { name: "Test E2E", stars: 5, category: "Tools" },
